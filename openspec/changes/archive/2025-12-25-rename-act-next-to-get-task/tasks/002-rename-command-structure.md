...
- [x] `openspec get task` returns the next prioritized task
- [x] `openspec get task --did-complete-previous` completes checkboxes and advances
- [x] `openspec get task --json` outputs valid JSON with `completedTask` field when applicable
