...
- [x] `openspec get task` returns expected output
- [x] `openspec get task --did-complete-previous` completes checkboxes correctly
- [x] `openspec get task --json` returns valid JSON with completedTask field
...
- [x] 6.5 Manual test: run `openspec get task` and verify output
- [x] 6.6 Manual test: run `openspec get task --did-complete-previous` and verify checkboxes marked
- [x] 6.7 Manual test: verify Constraints/Acceptance Criteria checkboxes unchanged
- [x] 6.8 Manual test: run `openspec get task --json` and verify JSON structure
