...
- [x] 1.2 Update directory structure example to remove `project.md` from openspec/ and show `ARCHITECTURE.md` at project root
...
- [x] 6.1 Update `ARCHITECTURE.md` reference from `openspec/project.md` to `ARCHITECTURE.md`

## 7. Update Existing Specs

- [x] 7.1 Update `openspec/specs/cli-init/spec.md` directory structure and file generation references
- [x] 7.2 Update `openspec/specs/openspec-conventions/spec.md` directory structure references

## 8. Regenerate AGENTS.md

- [x] 8.1 Run `openspec update` to regenerate `openspec/AGENTS.md` from updated template
...
- [x] 10.1 Delete `openspec/project.md` from the repository
