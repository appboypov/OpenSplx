...
- Agent instructions tell AI to "read `openspec/project.md`"
...
6. **Specs**: Update directory structure references to show `ARCHITECTURE.md` at project root (not inside openspec/)
...
- Affected specs: `cli-init`, `openspec-conventions`
- Affected code:
  ...
  - `README.md`
  - `ARCHITECTURE.md`
  - `openspec/AGENTS.md` (regenerated from template)
