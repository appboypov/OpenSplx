...
const FILE_PATHS: Record<SlashCommandId, string> = {
  'archive': '.augment/commands/splx-archive.md',
  'complete-task': '.augment/commands/splx-complete-task.md',
  'copy-next-task': '.augment/commands/splx-copy-next-task.md',
  'copy-review-request': '.augment/commands/splx-copy-review-request.md',
  'copy-test-request': '.augment/commands/splx-copy-test-request.md',
  'get-task': '.augment/commands/splx-get-task.md',
  'implement': '.augment/commands/splx-implement.md',
  'orchestrate': '.augment/commands/splx-orchestrate.md',
  'parse-feedback': '.augment/commands/splx-parse-feedback.md',
  'plan-implementation': '.augment/commands/splx-plan-implementation.md',
  'plan-proposal': '.augment/commands/splx-plan-proposal.md',
  'plan-request': '.augment/commands/splx-plan-request.md',
  'prepare-compact': '.augment/commands/splx-prepare-compact.md',
  'prepare-release': '.augment/commands/splx-prepare-release.md',
  'refine-architecture': '.augment/commands/splx-refine-architecture.md',
  'refine-release': '.augment/commands/splx-refine-release.md',
