...
const FILE_PATHS: Record<SlashCommandId, string> = {
  'archive': '.clinerules/workflows/splx-archive.md',
  'complete-task': '.clinerules/workflows/splx-complete-task.md',
  'copy-next-task': '.clinerules/workflows/splx-copy-next-task.md',
  'copy-review-request': '.clinerules/workflows/splx-copy-review-request.md',
  'copy-test-request': '.clinerules/workflows/splx-copy-test-request.md',
  'get-task': '.clinerules/workflows/splx-get-task.md',
  'implement': '.clinerules/workflows/splx-implement.md',
  'orchestrate': '.clinerules/workflows/splx-orchestrate.md',
  'parse-feedback': '.clinerules/workflows/splx-parse-feedback.md',
  'plan-implementation': '.clinerules/workflows/splx-plan-implementation.md',
  'plan-proposal': '.clinerules/workflows/splx-plan-proposal.md',
  'plan-request': '.clinerules/workflows/splx-plan-request.md',
  'prepare-compact': '.clinerules/workflows/splx-prepare-compact.md',
  'prepare-release': '.clinerules/workflows/splx-prepare-release.md',
  'refine-architecture': '.clinerules/workflows/splx-refine-architecture.md',
  'refine-release': '.clinerules/workflows/splx-refine-release.md',
