...
const FILE_PATHS: Record<SlashCommandId, string> = {
  'archive': '.cospec/splx/commands/splx-archive.md',
  'complete-task': '.cospec/splx/commands/splx-complete-task.md',
  'copy-next-task': '.cospec/splx/commands/splx-copy-next-task.md',
  'copy-review-request': '.cospec/splx/commands/splx-copy-review-request.md',
  'copy-test-request': '.cospec/splx/commands/splx-copy-test-request.md',
  'get-task': '.cospec/splx/commands/splx-get-task.md',
  'implement': '.cospec/splx/commands/splx-implement.md',
  'orchestrate': '.cospec/splx/commands/splx-orchestrate.md',
  'parse-feedback': '.cospec/splx/commands/splx-parse-feedback.md',
  'plan-implementation': '.cospec/splx/commands/splx-plan-implementation.md',
  'plan-proposal': '.cospec/splx/commands/splx-plan-proposal.md',
  'plan-request': '.cospec/splx/commands/splx-plan-request.md',
  'prepare-compact': '.cospec/splx/commands/splx-prepare-compact.md',
  'prepare-release': '.cospec/splx/commands/splx-prepare-release.md',
  'refine-architecture': '.cospec/splx/commands/splx-refine-architecture.md',
  'refine-release': '.cospec/splx/commands/splx-refine-release.md',
