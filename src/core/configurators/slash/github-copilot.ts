...
const FILE_PATHS: Record<SlashCommandId, string> = {
  'archive': '.github/prompts/splx-archive.prompt.md',
  'complete-task': '.github/prompts/splx-complete-task.prompt.md',
  'copy-next-task': '.github/prompts/splx-copy-next-task.prompt.md',
  'copy-review-request': '.github/prompts/splx-copy-review-request.prompt.md',
  'copy-test-request': '.github/prompts/splx-copy-test-request.prompt.md',
  'get-task': '.github/prompts/splx-get-task.prompt.md',
  'implement': '.github/prompts/splx-implement.prompt.md',
  'orchestrate': '.github/prompts/splx-orchestrate.prompt.md',
  'parse-feedback': '.github/prompts/splx-parse-feedback.prompt.md',
  'plan-implementation': '.github/prompts/splx-plan-implementation.prompt.md',
  'plan-proposal': '.github/prompts/splx-plan-proposal.prompt.md',
  'plan-request': '.github/prompts/splx-plan-request.prompt.md',
  'prepare-compact': '.github/prompts/splx-prepare-compact.prompt.md',
  'prepare-release': '.github/prompts/splx-prepare-release.prompt.md',
  'refine-architecture': '.github/prompts/splx-refine-architecture.prompt.md',
  'refine-release': '.github/prompts/splx-refine-release.prompt.md',
