...
const FILE_PATHS: Record<SlashCommandId, string> = {
  'archive': '.iflow/commands/splx-archive.md',
  'complete-task': '.iflow/commands/splx-complete-task.md',
  'copy-next-task': '.iflow/commands/splx-copy-next-task.md',
  'copy-review-request': '.iflow/commands/splx-copy-review-request.md',
  'copy-test-request': '.iflow/commands/splx-copy-test-request.md',
  'get-task': '.iflow/commands/splx-get-task.md',
  'implement': '.iflow/commands/splx-implement.md',
  'orchestrate': '.iflow/commands/splx-orchestrate.md',
  'parse-feedback': '.iflow/commands/splx-parse-feedback.md',
  'plan-implementation': '.iflow/commands/splx-plan-implementation.md',
  'plan-proposal': '.iflow/commands/splx-plan-proposal.md',
  'plan-request': '.iflow/commands/splx-plan-request.md',
  'prepare-compact': '.iflow/commands/splx-prepare-compact.md',
  'prepare-release': '.iflow/commands/splx-prepare-release.md',
  'refine-architecture': '.iflow/commands/splx-refine-architecture.md',
  'refine-release': '.iflow/commands/splx-refine-release.md',
