...
const FILE_PATHS: Record<SlashCommandId, string> = {
  ...
  'plan-implementation': '.qoder/commands/plx/plan-implementation.md',
  ...
  'refine-testing': '.qoder/commands/plx/refine-testing.md',
  'review': '.qoder/commands/plx/review.md',
  'sync-workspace': '.qoder/commands/plx/sync-workspace.md',
  'test': '.qoder/commands/plx/test.md',
  'undo-task': '.qoder/commands/plx/undo-task.md'
};
