...
const FILE_PATHS: Record<SlashCommandId, string> = {
  'archive': '.windsurf/workflows/splx-archive.md',
  'complete-task': '.windsurf/workflows/splx-complete-task.md',
  'copy-next-task': '.windsurf/workflows/splx-copy-next-task.md',
  'copy-review-request': '.windsurf/workflows/splx-copy-review-request.md',
  'copy-test-request': '.windsurf/workflows/splx-copy-test-request.md',
  'get-task': '.windsurf/workflows/splx-get-task.md',
  'implement': '.windsurf/workflows/splx-implement.md',
  'orchestrate': '.windsurf/workflows/splx-orchestrate.md',
  'parse-feedback': '.windsurf/workflows/splx-parse-feedback.md',
  'plan-implementation': '.windsurf/workflows/splx-plan-implementation.md',
  'plan-proposal': '.windsurf/workflows/splx-plan-proposal.md',
  'plan-request': '.windsurf/workflows/splx-plan-request.md',
  'prepare-compact': '.windsurf/workflows/splx-prepare-compact.md',
  'prepare-release': '.windsurf/workflows/splx-prepare-release.md',
  'refine-architecture': '.windsurf/workflows/splx-refine-architecture.md',
  'refine-release': '.windsurf/workflows/splx-refine-release.md',
