...
- [ ] 1.1 Create `src/commands/migrate.ts` with command skeleton
- [ ] 1.2 Register `migrate` command in `src/cli/index.ts`
- [ ] 1.3 Add `tasks` subcommand to migrate command
- [ ] 1.4 Implement workspace discovery and scanning logic
- [ ] 1.5 Implement task file scanning in `changes/*/tasks/` directories
- [ ] 1.6 Implement task file scanning in `reviews/*/tasks/` directories
- [ ] 1.7 Implement filename transformation: `NNN-<name>.md` -> `NNN-<parent-id>-<name>.md`
- [ ] 1.8 Implement frontmatter injection (add `parent-type`, `parent-id`)
- [ ] 1.9 Implement file move operation with collision detection
- [ ] 1.10 Implement empty directory cleanup
- [ ] 1.11 Add `--dry-run` flag implementation
- [ ] 1.12 Add `--json` flag implementation
- [ ] 1.13 Add migration summary output (terminal and JSON)
- [ ] 1.14 Add error handling and reporting
