...
- [ ] 3.1 Add `migrate` command to `src/core/completions/command-registry.ts`
- [ ] 3.2 Define `tasks` subcommand with available flags
- [ ] 3.3 Verify completions generate correctly
- [ ] 3.4 Test completions in Zsh shell
