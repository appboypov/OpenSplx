...
- [ ] 1.1 Add function to find tasks by parent in task discovery utilities
- [ ] 1.2 Update archive command to call new task discovery function
- [ ] 1.3 Parse frontmatter to filter by parent-type and parent-id
- [ ] 1.4 Return array of task file paths matching the archived entity
