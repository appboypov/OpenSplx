...
- [ ] 3.1 Update completion check to use task discovery results
- [ ] 3.2 Check frontmatter `status` field for each discovered task
- [ ] 3.3 Remove legacy `tasks.md` auto-migration code
- [ ] 3.4 Update incomplete tasks display to show filenames from centralized storage
