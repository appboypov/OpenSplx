...
- [ ] 6.1 Review task 001-004 implementations
- [ ] 6.2 Run `pnpm test` and fix failures
- [ ] 6.3 Run `pnpm build` and fix errors
- [ ] 6.4 Run `pnpm lint` and fix warnings
- [ ] 6.5 Verify code follows archive.ts patterns
