# cli-paste Specification

## Purpose
TBD - created by archiving change extend-paste-command. Update Purpose after archive.
## Requirements
...
- **AND** uses body structure from matching template in `workspace/templates/` based on task type
